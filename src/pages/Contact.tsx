      ...
      <div className="bg-white p-6 md:p-12 rounded-lg shadow-md max-w-5xl mx-auto mt-10">
        ...
        <div className="contact-info-row">
          ...
          <div className="info-card">
            ...
            <p className="info-detail">+91 12345 67890</p>
          </div>
          <div className="info-card">
            <FaEnvelope className="info-icon" />
            <p className="info-title">Email</p>
            <p className="info-detail">orca@pethostel.com</p>
          </div>
        </div>

        <div className="contact-message grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          <div>
            <h3 className="text-xl font-semibold mb-2">Message us / Call us</h3>
            <p>
              In case of change in appointment or any detailed queries, feel
              free to contact us.
            </p>
          </div>
        </div>
